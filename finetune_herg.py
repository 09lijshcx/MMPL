...
train_dataset = MoleculeHERGDataset("train", train_num=1000)
...
for e in range(0, Epoch):
    ...
    if auc > best_val:
        ...
        torch.save(ema.state_dict(), f'./trained_weight/MMPL_MTattn_fewshot_tune_herg_Epoch{e+1}_val_auc_{best_val:.5f}.pth') 
