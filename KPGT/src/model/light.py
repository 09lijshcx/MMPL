...
class LiGhTPredictor(nn.Module):
    ...
    def get_feats(self, g, fp, md):
       ...
       # Model
        ...
        readout, _ = dgl.topk_nodes(g, 'ht', k=30)
        # readout = dgl.unbatch(g)
        # for r in readout:
        #     print(r.ndata['ht'].shape)
        #     print(r.number_of_nodes())
        # return readout, fp_vn, md_vn
        return readout, fp_vn.unsqueeze(1), md_vn.unsqueeze(1)
